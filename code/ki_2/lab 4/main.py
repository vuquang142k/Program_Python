...
def draw(entry_1):
    ...
    C.create_line(rez_draw_xy[0],
                    rez_draw_xy[1],
                    rez_draw_xy[2],
                    rez_draw_xy[3],
                    width = 3,
                    fill = 'green')
    C.create_line(rez_draw_xy[2],
                    rez_draw_xy[3],
                    rez_draw_xy[4],
                    rez_draw_xy[5],
                    width = 3,
                    fill = 'green')
    C.create_line(rez_draw_xy[4],
                    rez_draw_xy[5],
                    rez_draw_xy[0],
                    rez_draw_xy[1],
                    width = 3,
...
def draw1(entry_1):
    ...
    C.create_line(list_trial[0][0],
                    list_trial[0][1],
                    list_trial[1][0],
                    list_trial[1][1],
                    width = 3,
                    fill = 'red')
    C.create_line(list_trial[1][0],
                    list_trial[1][1],
                    list_trial[2][0],
                    list_trial[2][1],
                    width = 3,
                    fill = 'red')
    C.create_line(list_trial[2][0],
                    list_trial[2][1],
                    list_trial[0][0],
                    list_trial[0][1],
                    width = 3,
...
e_but =  Button(roots, text='Paint points', font='consolas 12', command = lambda: draw1(xy))
